...
class EventScanner:
    ...
    def __init__(self, web3: Web3, contract: Contract, state: EventScannerState, events: List, filters: {},
                 max_chunk_scan_size: int = 1000, max_request_retries: int = 30, request_retry_seconds: float = 3.0):
        """
    ...
    def scan(self, start_block, end_block, start_chunk_size=1, progress_callback=Optional[Callable]) -> Tuple[
        list, int]:
...
if __name__ == "__main__":
    ...
    AAVE_LENDINGPOOL_V1_ADDRESS = "0x398eC7346DcD622eDc5ae82352F02bE94C62d119"
    AAVE_LENDINGPOOL_V1_ABI = '../abis/aave_v1/LendingPool.json'
    ABI = open(AAVE_LENDINGPOOL_V1_ABI)
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = '../data/aave1/eventscanner/ReserveUsedAsCollateralEnabled.json'
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            # borrow = {
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "amount": args._amount,
            #     "borrowRateMode": args._borrowRateMode,
            #     "borrowRate": args._borrowRate,
            #     "originationFee": args._originationFee,
            #     "borrowBalanceIncrease": args._borrowBalanceIncrease,
            #     "referral": args._referral,
            #     "event_timestamp": args._timestamp, 
            ...
            #     "reserve": args._reserve,
            #     "amount": args._amount,
            #     "totalFee": args._totalFee,
            #     "protocolFee": args._protocolFee,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(), 
            # }

            # liquidationcall = {
            #     "collateral": args._collateral,
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "purchaseAmount": args._purchaseAmount,
            #     "liquidatedCollateralAmount": args._liquidatedCollateralAmount,
            #     "accruedBorrowInterest": args._accruedBorrowInterest,
            #     "liquidator": args._liquidator,
            #     "receiveAToken": args._receiveAToken,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(),
            # }
            ...
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "feeLiquidated": args._feeLiquidated,
            #     "liquidatedCollateralForFee": args._liquidatedCollateralForFee,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(),
            # }
            ...
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "newStableRate": args._newStableRate,
            #     "borrowBalanceIncrease": args._borrowBalanceIncrease,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(),
            # }
            ...
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "repayer": args._repayer,
            #     "amountMinusFees": args._amountMinusFees,
            #     "fees": args._fees,
            #     "borrowBalanceIncrease": args._borrowBalanceIncrease,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(),
            ...
            #     "reserve": args._reserve,
            #     "user": args._user,
            #     "newRateMode": args._newRateMode,
            #     "newRate": args._newRate,
            #     "borrowBalanceIncrease": args._borrowBalanceIncrease,
            #     "event_timestamp": args._timestamp,
            #     "timestamp": block_when.isoformat(),
            # }
            ...
            self.state["blocks"][block_number][txhash][log_index] = reserveusedascollateralenabled
    ...
    def run():
        ...
        print(f'web.eth.get_block: {web3.eth.get_block}')

        # Prepare stub ERC-20 contract object
        ABI_json = '../abis/aave_v1/LendingPool.json'
        with open(ABI_json) as f:
            abi = json.loads(f.read())
        # ABI = open(AAVE_LENDINGPOOL_V1_ABI)
        # abi = json.loads(ABI)
        AAVE_LENDINGPOOL = web3.eth.contract(abi=abi)
        # print(AAVE_LENDINGPOOL.abi)
        ...
        scanner = EventScanner(
            web3=web3,
            contract=AAVE_LENDINGPOOL,
            state=state,
            events=[
                # AAVE_LENDINGPOOL.events.Borrow],
                # AAVE_LENDINGPOOL.events.Deposit, 
                # AAVE_LENDINGPOOL.events.FlashLoan, 
                # AAVE_LENDINGPOOL.events.LiquidationCall, 
                # AAVE_LENDINGPOOL.events.OriginationFeeLiquidated, 
                # AAVE_LENDINGPOOL.events.RebalanceStableBorrowRate,
                # AAVE_LENDINGPOOL.events.RedeemUnderlying,
                # AAVE_LENDINGPOOL.events.Repay,
                # AAVE_LENDINGPOOL.events.ReserveUsedAsCollateralDisabled,
                AAVE_LENDINGPOOL.events.ReserveUsedAsCollateralEnabled, 
                # AAVE_LENDINGPOOL.events.Swap,
            ],
            filters={"address": AAVE_LENDINGPOOL_V1_ADDRESS},
